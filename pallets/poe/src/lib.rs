...
pub mod pallet {
    //引入对应的依赖
    // use frame_support::{
    //     dispath::DispatchResultWithPostInfo,    //可调用函数的返回结果
    //     pallet_prelude::*   //runtime开发所需要的常用的宏
    // };
    use frame_support::pallet_prelude::*;
    use frame_system::pallet_prelude::*;    //系统模块
    use sp_std::vec::Vec;
    ...
    // 定义存储单元，proofs 用来存储存证 
    // key是u32 是一个hash值 owner，value是2个元素组成的tuple，第一个是用户id，第二个是区块
    #[pallet::storage]
